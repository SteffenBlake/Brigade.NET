...
--changeset brigade:postgres-schema
CREATE TABLE accounts (id INT PRIMARY KEY, name VARCHAR(100) NOT NULL, note VARCHAR(100) NULL);
CREATE TABLE orders (id INT PRIMARY KEY, buyer_id INT NOT NULL, seller_id INT NOT NULL, "order" VARCHAR(100) NOT NULL, amount INT NOT NULL);
CREATE TABLE order_tags (order_id INT NOT NULL, tag VARCHAR(40) NOT NULL, PRIMARY KEY (order_id, tag));
--changeset brigade:postgres-seed
...
CREATE TABLE shipments (id INT PRIMARY KEY, order_id INT NOT NULL, delivered_at VARCHAR(30) NULL);
