...
CREATE TABLE purchases (id INTEGER PRIMARY KEY, buyer_id INTEGER NOT NULL, seller_id INTEGER NOT NULL, "purchase" TEXT NOT NULL, amount INTEGER NOT NULL);
CREATE TABLE purchase_tags (purchase_id INTEGER NOT NULL, tag TEXT NOT NULL, PRIMARY KEY (purchase_id, tag));
...
ALTER TABLE purchases ADD COLUMN category_id INTEGER NOT NULL DEFAULT 101;
ALTER TABLE purchases ADD COLUMN status TEXT NOT NULL DEFAULT 'open';
CREATE TABLE categories (id INTEGER PRIMARY KEY, parent_id INTEGER NULL, label TEXT NOT NULL);
CREATE TABLE shipments (id INTEGER PRIMARY KEY, purchase_id INTEGER NOT NULL, delivered_at TEXT NULL);
