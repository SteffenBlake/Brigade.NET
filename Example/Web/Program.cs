...
builder.Services.AddKeyedSingleton<DbProviderFactory>(ServiceNames.SqlServer, SqlClientFactory.Instance);
builder.Services.AddKeyedSingleton<DbProviderFactory>(ServiceNames.PostgreSql, NpgsqlFactory.Instance);
builder.Services.AddKeyedSingleton<DbProviderFactory>(ServiceNames.Sqlite, SqliteFactory.Instance);
builder.Services.AddKeyedSingleton<DbProviderFactory>(ServiceNames.MySql, MySqlConnectorFactory.Instance);
builder.Services.AddKeyedSingleton<DbProviderFactory>(ServiceNames.MariaDb, MySqlConnectorFactory.Instance);
builder.Services
