...
public static partial class Routing
{
    ...
    private static partial class Mise
    {
        ...
        private static partial class SqlServer
        {
            ...
            static void SearchPurchases(RouteHandlerBuilder route)
            {
                route.AllowAnonymous();
            }

            [AccountSearchSqlServerV1HandlerRoute.Get("accounts")]
            static void SearchAccounts(RouteHandlerBuilder route)
            {
                route.AllowAnonymous();
            }

            [AccountUpdateSqlServerV1HandlerRoute.Post("accounts/update")]
            static void UpdateAccount(RouteHandlerBuilder route)
            {
                route.AllowAnonymous();
            }
        }
    ...
    private static partial class Orders
    {
        ...
        static void Create(RouteHandlerBuilder route)
        {
            route.AllowAnonymous();
        }
        ...
        static void Search(RouteHandlerBuilder route)
        {
            route.AllowAnonymous();
        }
        ...
        static void Delete(RouteHandlerBuilder route)
        {
            route.AllowAnonymous();
        }

        [OrderValidateV1HandlerRoute.Post("validate")]
        static void Validate(RouteHandlerBuilder route)
        {
            route.AllowAnonymous();
        }
    }
    ...
    private static partial class PolicyTests
    {
        ...
        static void C(RouteHandlerBuilder route)
        {
        ...
        static void D(RouteHandlerBuilder route)
        {
