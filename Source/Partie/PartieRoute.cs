...
/// <summary>
/// A transport-neutral route with its statically compiled pipeline.
/// </summary>
...
public sealed record PartieRoute<TInputs, TResult>(
    string name,
...
)
{
    ...
    /// <summary>
    /// Invokes the compiled pipeline with already-bound values.
    /// </summary>
