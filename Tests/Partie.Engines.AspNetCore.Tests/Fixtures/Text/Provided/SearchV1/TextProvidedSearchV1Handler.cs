...
public sealed record TextProvidedSearchV1Context(
    [Provide] int Made,
    [Provide] TextProvidedSearchV1Query Query
);

public sealed class TextProvidedSearchV1Handler
    : IQueryHandler<TextProvidedSearchV1Query, string, TextProvidedSearchV1Context>
{
